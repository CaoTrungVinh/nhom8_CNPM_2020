...
class AssistRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AssistRequest', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class AssistResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AssistResponse', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..e<AssistResponse_EventType>(1, 'eventType', $pb.PbFieldType.OE, defaultOrMaker: AssistResponse_EventType.EVENT_TYPE_UNSPECIFIED, valueOf: AssistResponse_EventType.valueOf, enumValues: AssistResponse_EventType.values)
    ..pc<SpeechRecognitionResult>(2, 'speechResults', $pb.PbFieldType.PM, subBuilder: SpeechRecognitionResult.create)
    ..aOM<AudioOut>(3, 'audioOut', subBuilder: AudioOut.create)
    ..aOM<ScreenOut>(4, 'screenOut', subBuilder: ScreenOut.create)
    ..aOM<DialogStateOut>(5, 'dialogStateOut', subBuilder: DialogStateOut.create)
...
class DebugInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DebugInfo', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
...
class AssistConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AssistConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..oo(0, [1, 6])
    ..aOM<AudioInConfig>(1, 'audioInConfig', subBuilder: AudioInConfig.create)
    ..aOM<AudioOutConfig>(2, 'audioOutConfig', subBuilder: AudioOutConfig.create)
    ...
    ..aOS(6, 'textQuery')
    ..aOM<ScreenOutConfig>(8, 'screenOutConfig', subBuilder: ScreenOutConfig.create)
    ..hasRequiredFields = false
  ;
...
class AudioInConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioInConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..e<AudioInConfig_Encoding>(1, 'encoding', $pb.PbFieldType.OE, defaultOrMaker: AudioInConfig_Encoding.ENCODING_UNSPECIFIED, valueOf: AudioInConfig_Encoding.valueOf, enumValues: AudioInConfig_Encoding.values)
...
class AudioOutConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioOutConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..e<AudioOutConfig_Encoding>(1, 'encoding', $pb.PbFieldType.OE, defaultOrMaker: AudioOutConfig_Encoding.ENCODING_UNSPECIFIED, valueOf: AudioOutConfig_Encoding.valueOf, enumValues: AudioOutConfig_Encoding.values)
    ..a<$core.int>(2, 'sampleRateHertz', $pb.PbFieldType.O3)
...
class ScreenOutConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ScreenOutConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..e<ScreenOutConfig_ScreenMode>(1, 'screenMode', $pb.PbFieldType.OE, defaultOrMaker: ScreenOutConfig_ScreenMode.SCREEN_MODE_UNSPECIFIED, valueOf: ScreenOutConfig_ScreenMode.valueOf, enumValues: ScreenOutConfig_ScreenMode.values)
    ..hasRequiredFields = false
  ;
...
class DialogStateIn extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DialogStateIn', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, 'conversationState', $pb.PbFieldType.OY)
    ..aOS(2, 'languageCode')
    ..aOM<DeviceLocation>(5, 'deviceLocation', subBuilder: DeviceLocation.create)
...
class DeviceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, 'deviceId')
    ..aOS(3, 'deviceModelId')
    ..hasRequiredFields = false
  ;
...
class AudioOut extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AudioOut', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
...
class ScreenOut extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('ScreenOut', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..e<ScreenOut_Format>(1, 'format', $pb.PbFieldType.OE, defaultOrMaker: ScreenOut_Format.FORMAT_UNSPECIFIED, valueOf: ScreenOut_Format.valueOf, enumValues: ScreenOut_Format.values)
...
class DeviceAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceAction', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
...
class SpeechRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('SpeechRecognitionResult', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, 'transcript')
...
class DialogStateOut extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DialogStateOut', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, 'supplementalDisplayText')
    ..a<$core.List<$core.int>>(2, 'conversationState', $pb.PbFieldType.OY)
    ..e<DialogStateOut_MicrophoneMode>(3, 'microphoneMode', $pb.PbFieldType.OE, defaultOrMaker: DialogStateOut_MicrophoneMode.MICROPHONE_MODE_UNSPECIFIED, valueOf: DialogStateOut_MicrophoneMode.valueOf, enumValues: DialogStateOut_MicrophoneMode.values)
...
class DebugConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DebugConfig', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
...
class DeviceLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('DeviceLocation', package: const $pb.PackageName('google.assistant.embedded.v1alpha2'), createEmptyInstance: create)
    ..oo(0, [1])
